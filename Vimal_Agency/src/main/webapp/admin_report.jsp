                ...
                <% if (session.getAttribute("admin_id")==null) {
                    ...
                    <body>
                        ...
                        <div class="admin-main">
                            <!-- Main Top Header -->
                            <div
                                class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom no-print">
                                <div>
                                    <h2 style="font-weight: 700; color: #212529; margin: 0; font-size: 24px;">Customer
                                        Accounts Ledger</h2>
                                    <p style="color: #6c757d; margin: 3px 0 0 0; font-size: 13px;">Manage distributors,
                                        view registered profiles, and track complete invoice histories.</p>
                                </div>
                                <button onclick="window.print()"
                                    class="btn btn-sm btn-outline-secondary fw-bold text-dark px-3 py-2"
                                ...
                                <table class="table align-middle mb-0 table-bordered">
                                    ...
                                    <tbody>
                                        <% Connection con=null; Connection conOrders=null; Connection conItems=null;
                                            ...
                                            conItems=DatabaseManager.getConnection(); // 1️⃣ LEVEL 1: Unique User
                                            ...
                                            !rawName.equals(".")) ? rawName : "Client ID: " + uId; String
                                            cPhone=rsUsers.getString("phone"); String cCity=rsUsers.getString("city");
                                            %>
                                            <!-- USER ROW -->
                                            <tr class="master-user-row" data-bs-toggle="collapse"
                                                data-bs-target="#crmBox_<%= uId %>">
                                                <td class="ps-3 fw-bold text-secondary">#<%= uId %>
                                                </td>
                                                <td class="fw-bold text-dark"><i
                                                        class="fa-solid fa-folder me-2 text-muted"
                                                        ...
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-lg-5">
                                                                <div class="info-card">
                                                                    ...
                                                                    <div class="info-row"><span
                                                                            class="info-label">Name</span><span
                                                                            class="info-value">
                                                                            <%= cName %>
                                                                        </span></div>
                                                                    <div class="info-row"><span
                                                                            class="info-label">Client Code</span><span
                                                                            class="info-value">VIMAL-<%= uId %></span>
                                                                    </div>
                                                                    <div class="info-row"><span
                                                                            class="info-label">Mobile</span><span
                                                                            class="info-value text-primary">
                                                                            <%= (cPhone !=null && !cPhone.equals(".")) ?
                                                                                cPhone : "N/A" %>
                                                                        </span></div>
                                                                    <div class="info-row" style="border-bottom: 0;">
                                                                        <span class="info-label">City</span><span
                                                                            class="info-value">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <div class="orders-card">
                                                                    ...
                                                                    <table
                                                                        class="table mb-0 align-middle table-sm border-0">
                                                                        <thead
                                                                            style="background: #f1f3f5; font-size: 12px; color: #495057;">
                                                                            <tr>
                                                                        ...
                                                                        <tbody>
                                                                            <% String
                                                                                ...
                                                                                while(rsOrders.next()) { hasOrders=true;
                                                                                ...
                                                                                statusPill="status-del" ; else
                                                                                if(oStatus.equalsIgnoreCase("Cancelled"))
                                                                                statusPill="status-can" ; } %>
                                                                                <!-- Level 2 Invoice Row -->
                                                                                <tr class="order-row-header"
                                                                                    data-bs-toggle="collapse"
                                                                                    data-bs-target="#innerItems_<%= oId %>">
                                                                                    <td
                                                                                        class="ps-3 fw-bold text-primary">
                                                                                        <i class="fa-solid fa-angle-right me-1 text-muted"
                                                                                ...
                                                                                <tr id="innerItems_<%= oId %>"
                                                                                    class="collapse">
                                                                                    <td colspan="4"
                                                                                        class="p-0 bg-light">
                                                                                        <div
                                                                                            class="inner-item-box border">
                                                                                            <table
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <% String
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td
                                                                                                                class="text-end fw-bold text-dark pe-2">
                                                                                                                ₹<%= String.format("%.2f",
                                                                                                                    total)
                                                                                                                    %>
                                                                                                            </td>
                        ...
                        <% } } catch(Exception e) { out.println("<tr>
                            <td colspan='5' class='text-danger p-3'>System error occurred: "+e.getMessage()+"</td>
                            </tr>");
                            } finally {
