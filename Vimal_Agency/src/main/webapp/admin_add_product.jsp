        ...
        <%@ page import="java.sql.*" %>
            <%@ page import="com.vimal.utils.DatabaseManager" %>
                ...
                <% //==========================================================// 1️⃣ ADMIN SESSION SECURITY CHECK
                    ...
                    // redirect admin to login page for security. if (session.getAttribute("admin_id")==null) {
                    response.sendRedirect("admin_login.jsp"); return; // Stop further page execution } %>
                    ...
                    <body>
                        ...
                        <%@ include file="admin_header.jsp" %>
                            ...
                            <div class="admin-main">
                                ...
                                <% //==========================================================// 2️⃣ PRODUCT INSERT
                                    LOGIC (ONLY EXECUTES ON POST REQUEST)
                                    //==========================================================if(request.getMethod().equalsIgnoreCase("POST"))
                                    { // Set UTF-8 encoding to support special characters & emojis
                                    request.setCharacterEncoding("UTF-8"); //
                                    ------------------------------------------------------ // Retrieve Form Data from
                                    Request // ------------------------------------------------------ String
                                    p_name=request.getParameter("p_name"); String
                                    p_price=request.getParameter("p_price"); String p_cat=request.getParameter("p_cat");
                                    String p_img=request.getParameter("p_img"); String
                                    p_desc=request.getParameter("p_desc"); String p_code=request.getParameter("p_code");
                                    try { // ------------------------------------------------------ // Load MySQL JDBC
                                    Driver // ------------------------------------------------------ // Establish
                                    database connection with Unicode support Connection
                                    con=DatabaseManager.getConnection(); //
                                    ------------------------------------------------------ // SQL INSERT Query (Matches
                                    Database Columns) // ------------------------------------------------------ String
                                    query="INSERT INTO products (code, product_name, product_price, product_category, product_describe, product_image) "
                                    + "VALUES (?, ?, ?, ?, ?, ?)" ; PreparedStatement ps=con.prepareStatement(query); //
                                    Set values into prepared statement ps.setString(1, p_code); // Product Code
                                    ps.setString(2, p_name); // Product Name ps.setString(3, p_price); // Product Price
                                    ps.setString(4, p_cat); // Product Category ps.setString(5, p_desc); // Product
                                    Description ps.setString(6, p_img); // Product Image Path // Execute insert query
                                    int result=ps.executeUpdate(); // Close database connection con.close(); //
                                        ...
                                        <form action="admin_add_product.jsp" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="p_code" class="form-control shadow-none"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="p_price" class="form-control shadow-none"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="p_desc" class="form-control shadow-none" rows="3"
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="text" name="p_img" class="form-control shadow-none"
