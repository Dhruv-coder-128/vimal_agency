<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ page import="com.vimal.utils.DatabaseManager" %>
                    ...
                    <%@ page import="com.vimal.utils.DatabaseManager" %>
                        <%@ page import="java.util.Date" %>
                            <%@ page import="com.vimal.utils.DatabaseManager" %>
                                ...
                                <% //==========================================================// 1️ ADMIN SESSION
                                    SECURITY CHECK //==========================================================// If
                                    admin is not logged in, redirect to login page if
                                    (session.getAttribute("admin_id")==null) { response.sendRedirect("admin_login.jsp");
                                    return; // Stop further execution } String successMsg=null;
                                    //==========================================================// 2️ DATABASE
                                    CONNECTION (UTF-8 ENABLED)
                                    //==========================================================// Unicode support
                                    ensures emojis and special characters work properly Connection
                                    con=DatabaseManager.getConnection();
                                    //==========================================================// 3️ DELETE LOGIC WITH
                                    REDIRECT //==========================================================// If del_id
                                    parameter is present in URL, delete that feedback if(request.getParameter("del_id")
                                    !=null) { try { PreparedStatement
                                    ps=con.prepareStatement( "DELETE FROM feedback WHERE id = ?" ); ps.setString(1,
                                    request.getParameter("del_id")); int rows=ps.executeUpdate(); // If deletion
                                    successful, redirect with status parameter if(rows> 0) {
        ...
        ========================================================== -->
                                                <div class="stat-card p-0 overflow-hidden" style="background: white; border-radius: 15px; 
                    ...
                    border-top: 5px solid #ffc800;">
                                                    ...
                                                    <table class="table table-hover align-middle mb-0 text-center">
                                                        ...
                                                        <tbody>
                                                            <% try { // Fetch feedback records in descending order
                                                                ResultSet
                                                                rs=con.createStatement().executeQuery( "SELECT * FROM feedback ORDER BY id DESC"
                                                                ); // Date format conversion SimpleDateFormat
                                                                dbFormat=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                                                                SimpleDateFormat userFormat=new
                                                                SimpleDateFormat("dd-MM-yyyy | hh:mm a");
                                                                while(rs.next()) { int rating=rs.getInt("experience");
                                                                String rawDate=rs.getString("created_at"); String
                                                                finalDate="" ; if(rawDate !=null) { Date
                                                                date=dbFormat.parse(rawDate);
                                                                ...
                                                                <tr style="border-bottom: 1px solid #f1f1f1;">
                                                                        ...
                                                                        <div class="star-rating">
                                                                            <% for(int i=1; i<=5; i++) { %>
                                                                                ...
                                                                                <i class="<%= (i <= rating) ? "
                                                                                    ...
                                                                                    fa-star"></i>
                                                                                <% } %>
                                                                                    <span class="ms-1">(<%= rating %>
                                                                                            )</span>
                                                                        </div>
                                                                    </td>

                                                                    <!-- Feedback Message -->
                                                                    <td class="text-start msg-cell text-truncate"
                                                                    ...
                                                                    <!-- Delete Action -->
                                                                    <td>
                                                                        <a href="admin_feedback.jsp?del_id=<%= rs.getInt("
                                                                            id") %>"
                                                                            class="btn-delete"
