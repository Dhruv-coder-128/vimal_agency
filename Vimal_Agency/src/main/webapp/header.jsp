<%@ page import="java.sql.*" %>
    <%@ page import="com.vimal.utils.DatabaseManager" %>
        ...
        <% String pageName=request.getRequestURI(); pageName=pageName.substring(pageName.lastIndexOf("/") + 1); /* 🔥
            SESSION USERNAME */ String uname=(String)session.getAttribute("username"); %>
                                        ...
                                        <div class="user-trigger" onclick="toggleUserMenu()">
                                            ...
                                            <div class="user-info-text">
                                                ...
                                                <span class="uname-text">
                                                    <%= uname %> <i class="fa-solid fa-chevron-down"
