...
<head>
    ...
    <style>
        ...
        .orb-pending { background: #fef3c7; color: #b45309; }
        .orb-delivered { background: #d1fae5; color: #047857; }
        .orb-cancelled { background: #ffe4e6; color: #be123c; }
        ...
        .invoice-chip:hover { opacity: 0.8; }
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="text-muted small">
                        <i class="fa-regular fa-calendar me-1"></i> <%= sdf.format(rs.getTimestamp("order_date")) %>
                    </div>
                </div>
            </div>
        ...
        <div id="items-<%= oId %>" class="summary-pane">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-7">
                    ...
                    %>
                    <div class="item-chip">
                        <img src="<%= rsI.getString("image") %>" alt="Product Image">
                ...
                <div class="col-lg-5 border-start-lg ps-lg-4">
                    ...
                    <div class="bg-white p-3 rounded-3 mb-3 border">
                        <div class="text-warning-emphasis small fw-700 mb-1"><i class="fa-solid fa-location-dot me-2 text-warning"></i>Shipping Address</div>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge rounded-pill text-capitalize px-3 py-2 <%= orbClass %>">
                            <%= status %>
                        </span>
                    </div>
                </div>
