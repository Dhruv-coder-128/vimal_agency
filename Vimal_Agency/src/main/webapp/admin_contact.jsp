<%@ page contentType="text/html;charset=UTF-8" %>
    <%@ page import="com.vimal.utils.DatabaseManager" %>
        ...
        ========================================================== */
                                        ...
                                        /* Improve table cell padding and alignment */
                                        .table td,
                                        .table th {
        ...
        ========================================================== */
                                        ...
                                        /* ==========================================================
           PROFESSIONAL SUCCESS TOAST DESIGN
        ========================================================== */
                                    ...
                                    <%@ include file="admin_header.jsp" %>
                                        ...
                                        <div class="admin-main p-4">
                                            ...
                                            <% //==========================================================// DATABASE
                                                CONNECTION
                                                //==========================================================String
                                                successMsg=null; Connection con=DatabaseManager.getConnection();
                                                //==========================================================// DELETE
                                                LOGIC (Triggered when del_id parameter is present)
                                                //==========================================================if(request.getParameter("del_id")
                                                !=null) { PreparedStatement
                                                ps=con.prepareStatement( "DELETE FROM contact_us WHERE id = ?" );
        ...
        ========================================================== -->
                    ...
                    border-top: 5px solid #ffc800;">
                                                    ...
                                                    <table class="table table-hover align-middle mb-0 text-center">
                                                        ...
                                                        <tbody>
                                                            <% try { // Fetch all contact leads in descending order
                                                                ResultSet
                                                                rs=con.createStatement().executeQuery( "SELECT * FROM contact_us ORDER BY id DESC"
                                                                ); // Date format from database SimpleDateFormat
                                                                dbFormat=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); //
                                                                User-friendly display format SimpleDateFormat
                                                                userFormat=new SimpleDateFormat("dd-MM-yyyy | hh:mm a");
                                                                while(rs.next()) { String mobile=rs.getString("cno");
                                                                String rawDate=rs.getString("created_time"); String
                                                                finalDate="" ; // Convert DB date into formatted display
                                                                date if(rawDate !=null) { Date
                                                                ...
                                                                <tr style="border-bottom: 1px solid #f1f1f1;">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex flex-column gap-1">
                                                                            ...
                                                                            <a href="tel:<%= mobile %>"
                                                                                ...
                                                                                <i
                                                                                    class="fa-solid fa-phone me-1 text-primary"></i>
                                                                                <%= mobile %>
                                                                            </a>

                                                                            <!-- WhatsApp Direct Chat -->
                                                                            <a href="https://wa.me/91<%= mobile %>"
                                                                                target="_blank"
                                                                    ...
                                                                    <!-- Delete Button -->
                                                                    <td>
                                                                        <a href="admin_contact.jsp?del_id=<%= rs.getInt("
                                                                            id") %>"
                                                                            class="btn-delete"
