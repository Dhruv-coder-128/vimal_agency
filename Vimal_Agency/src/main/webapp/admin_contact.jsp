...
<body>
    ...
    <div class="admin-main p-4">
        ...
        <%
            ...
            // ==========================================================
            // DELETE LOGIC (Triggered when del_id parameter is present)
            // ==========================================================
        ...
        <div class="stat-card p-0 overflow-hidden" 
            ...
            <table class="table table-hover align-middle mb-0 text-center">
                ...
                <tbody>
                    <%
                        try {
                            // Fetch all contact leads in descending order
                            ...
                            while(rs.next()) {
                                ...
                                // Convert DB date into formatted display date
                                if(rawDate != null) {
                    ...
                    <tr style="border-bottom: 1px solid #f1f1f1;">
                        ...
                        <!-- Delete Button -->
                        <td>
                            <a href="admin_contact.jsp?del_id=<%= rs.getInt("id") %>" 
                               class="btn-delete"
